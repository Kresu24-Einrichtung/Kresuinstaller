...
echo "screen -S Server -d java -Xmx1024M -Xms1024M -jar server.jar nogui">> start.sh
chmod 777 start.sh
bash start.sh
...
echo "eula=true">> eula.txt
echo "screen -S Server -d java -Xmx1024M -Xms1024M -jar spigot-1.18.jar nogui">> start.sh
chmod 777 start.sh
bash start.sh
echo "Installation abgeschlossen!"
fi